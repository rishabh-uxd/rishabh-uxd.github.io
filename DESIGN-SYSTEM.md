...
- **Large monitors and ultrawides.** Nothing in the design may follow `vw` alone.
  ...
  **`.practice-lead` joined them 2026-09-22, and it is the one to understand, because it
  ...
  measures 148 characters on the worst line at 2560, 104 at 1280, and is inside 80 up to
  about 950px of viewport. **It qualifies on the line-count argument, not in spite of
  it**: two lines a paragraph at every width from 1280 up, which is the same property
  that makes a two-sentence caption safe at 237. **So its budget is two lines a
  paragraph, about 320 characters**, and today's are 205 and 207. A paragraph that
  reaches a third line at 2560 has broken the argument, and unlike a capped paragraph,
  longer copy here lengthens the worst line rather than adding lines to a short one, up
  to the 161 character capacity of a 1690px container. Trim it, never narrow it.
